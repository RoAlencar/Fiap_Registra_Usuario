...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleModificaUsuarioException(ModificaUsuarioException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "Não foi possivel atualizar o usuário", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleTipoUsuarioException(TipoUsuarioRequiredException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "O tipo de usuário é obrigatório", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleUserNotFoundException(UserNotFoundException ex,
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(buildProblemDetail(HttpStatus.NOT_FOUND, "O usuario não foi encontrado.", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleAddressRequiredException(AddressRequiredException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "O endereço do usuário é obrigatório", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleEmailRequiredException(EmailRequiredException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "O email do usuário é obrigatório", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handleNameRequiredException(NameRequiredException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "O nome do usuário é obrigatório", request));
    }
    ...
    public ResponseEntity<ProblemDetail> handlePasswordRequiredException(PasswordRequiredException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildProblemDetail(HttpStatus.BAD_REQUEST, "A senha do usuário é obrigatória", request));
    }

    @ExceptionHandler(PasswordUpdateNotAllowedException.class)
    public ResponseEntity<ProblemDetail> handlePasswordUpdateNotAllowedExecption(PasswordUpdateNotAllowedException ex,
            HttpServletRequest request) {
